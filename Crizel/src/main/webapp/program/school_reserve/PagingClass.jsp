...
public class Paging {
    ...
    private void makePaging() {
        ...
        this.setEndRowNo(pageNo * pageSize);
        this.setRowNo(totalCount - ((pageNo-1) * pageSize));
    }
    ...
    public String getHtml(String mode) {
    	...
    	for(int i=this.startPageNo; i<=this.endPageNo; i++) {
    		if(i == this.pageNo) {
    			if("2".equals(mode)) {
    				html.append("<a href=\"javascript:;\" class=\"on\" onclick=\"goPage(");
    	...
    	html.append("function goPage(page) { \n");
    	html.append("	document.pagingForm.pageNo.value = page; \n");
    	html.append("	document.pagingForm.submit(); \n");
    	html.append("} \n");
    	html.append("</script> \n");
