...
String reserve_type = parseNull(request.getParameter("reserve_type"), "교실");
String reserve_type2 = parseNull(request.getParameter("reserve_type2"), "");
String count = parseNull(request.getParameter("count"), "4");
...
String date_start = parseNull(request.getParameter("date_start"),"2017-12-06");
String date_end = parseNull(request.getParameter("date_end"),"2017-12-08");
String time_start = parseNull(request.getParameter("time_start"),"0000");
String time_end = parseNull(request.getParameter("time_end"),"0200");
