...
String room_id = parseNull(request.getParameter("room_id"),"1");
String count = parseNull(request.getParameter("count"),"1");
String first = parseNull(request.getParameter("first"));
String last = parseNull(request.getParameter("last"));
