...
String insertPage 	= 	"DOM_000000126002003007";	// 실서버 : DOM_000002001002003003 , 테스트 : DOM_000000126002003007
...
int num         =   0;
    ...
    sql_str +=  "	, (SELECT PRO_NO FROM ART_REQ_ALWAY_CNT WHERE REQ_NO = COMPARE_DATE.REQ_NO) AS PRO_NO		";
    sql_str +=  ", CASE ";
                ...
                for(ArtCalData data : calDateList){
                    ...
                    if (!tmpDate.equals(data.callDate)) {
                        ...
                        if (data.hlyDateFlag.equals("SU")) {
                            ...
                            //오늘 과 이전 날짜 확인
                            if ((diffDate <= todayAft || diffDate > 130) 
								|| (Integer.parseInt(compareDay) > 20180727)
