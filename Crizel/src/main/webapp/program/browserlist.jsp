...
for(VisitCounterVO c : counterVOList){	
	...
	try{
		...
		searchDate[dateCnt] = c.getBrowser();
		dateCnt++;
	}catch(Exception ex){
		out.println(ex);
		dateCnt++;
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko">
	<head>
		...
		<script type="text/javascript">
			...
			{
				document.listForm.action = "browserdownload.sko";
				document.listForm.submit();
				document.listForm.action = "browserlist.sko";
			}
...
<body>
	...
	<div id="right_view">
		<h2>통계관리<img src="<%=request.getContextPath()%>/images/egovframework/rfc3/iam/images/location_img.gif" alt=""  class="loca_img"/>접속자 통계 <img src="<%=request.getContextPath()%>/images/egovframework/rfc3/iam/images/location_img.gif" alt=""  class="loca_img"/><span>브라우저 통계</span></h2>
		...
		<div id="content">
			<div class="select01" style="margin:0 0 10px 0;">
				<div class="select02" style="padding:8px 0 0 8px;">
					...
					<span class="btn_pack medium"><input value="브라우저 통계" type="submit" onclick="document.location='browserlist.sko';return false;"></span>
			...
			<div class="select01">
				...
				<!-- 상단 검색 영역  -->
				<div class="select02">
					<form name="listForm" action="browserlist.sko" method="get" class="search">
						<fieldset>
							<legend>검색하기</legend>
