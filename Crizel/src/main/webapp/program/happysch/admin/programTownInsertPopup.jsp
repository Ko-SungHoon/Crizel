<%
/**
*   PURPOSE :   주제별마을학교 프로그램 insert popup page
...
try{
	if(!"".equals(pro_no)){
		...
		sql.append("SELECT HAPPY_PRO_TOWN.*						");
	...
	sql.append("WHERE CODE_NAME = 'HAPPY_PRO_TOWN' 		");
...
<div id="right_view">
	...
	<div id="content">
		<div class="listArea">
			<form action="programTownInsertAction.jsp" method="post" id="insertForm" name="insertForm" onsubmit="return insertSubmit();">
				<fieldset>
              ...
              <th>
                ...
                <td>
                    <select id="pro_time" name="pro_time">
                        ...
                        <option value="평일 오전 (09:30~12:00)" <%if("평일 오전 (09:30~12:00)".equals(vo.pro_time)){%> selected="selected" <%}%> >평일 오전 (09:30~12:00)</option>
                        <option value="평일 오후 (14:00~16:30)" <%if("평일 오후 (14:00~16:30)".equals(vo.pro_time)){%> selected="selected" <%}%> >평일 오후 (14:00~16:30)</option>
						<option value="월,금 저녁 (18:00)~(20:30)" <%if("월,금 저녁 (18:00)~(20:30)".equals(vo.pro_time)){%> selected="selected" <%}%> >월,금 저녁 (18:00)~(20:30)</option>
						<option value="화,목 저녁 (18:00)~(20:30)" <%if("화,목 저녁 (18:00)~(20:30)".equals(vo.pro_time)){%> selected="selected" <%}%> >화,목 저녁 (18:00)~(20:30)</option>
                    </select>
                </td>
            </tr>
						<tr>
