<%
/**
*   PURPOSE :   학교연계프로그램 추가 popup page
...
try{
	if(!"".equals(pro_no)){
		...
		sql.append("SELECT HAPPY_PRO_SCH.*					");
		sql.append("	, (SELECT NVL(MAX(HAPPY_REQ_SCH_CNT.REQ_PER), 0) FROM HAPPY_REQ_SCH_CNT WHERE PRO_NO = HAPPY_PRO_SCH.PRO_NO) AS REQ_PER ");
...
<div id="right_view">
	...
	<div id="content">
		<div class="listArea">
			<form action="programSchoolInsertAction.jsp" method="post" id="insertForm" name="insertForm" onsubmit="return insertSubmit();">
				<fieldset>
