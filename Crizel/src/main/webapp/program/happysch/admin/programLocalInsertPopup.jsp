<%
/**
*   PURPOSE :   지역민 평생교육프로그램 insert popup page
...
try{
	if(!"".equals(pro_no)){
		...
		sql.append("SELECT HAPPY_PRO_LOCAL.*						");
...
<div id="right_view">
	...
	<div id="content">
		<div class="listArea">
			<form action="programLocalInsertAction.jsp" method="post" id="insertForm" name="insertForm" onsubmit="return insertSubmit();">
				<fieldset>
            ...
            <tr>
                ...
                <td>
                    <select id="pro_time" name="pro_time">
                        <option value="토요일 (10:00~13:00)" <%if("토요일 (10:00~13:00)".equals(vo.pro_time)){%> selected="selected" <%}%> >토요일 (10:00~13:00)</option>
                        <option value="평일 오전(9:30~12:00)" <%if("평일 오전(9:30~12:00)".equals(vo.pro_time)){%> selected="selected" <%}%> >평일 오전(9:30~12:00)</option>
                        <option value="화,목 오후(14:00~16:30)" <%if("화,목 오후(14:00~16:30)".equals(vo.pro_time)){%> selected="selected" <%}%> >화,목 오후(14:00~16:30)</option>
						<option value="화 오후 14:00~16:30" <%if("화 오후 14:00~16:30".equals(vo.pro_time)){%> selected="selected" <%}%> >화 오후 14:00~16:30</option>
						<option value="목 오후 14:00~16:30" <%if("목 오후 14:00~16:30".equals(vo.pro_time)){%> selected="selected" <%}%> >목 오후 14:00~16:30</option>
                    </select>
                </td>
            </tr>
						<tr>
