      ...
      <fieldset>
        <legend>사용자정보 일괄등록하기</legend>
          ...
          <div class="topbox2">
            ...
            <input value="샘플파일" id="sample" type="button" onclick="location.href='/program/down.jsp?path=/program/works&filename=sample_user.xls'" class="btn small edge mako">
            </p>
            ...
            <p class="inputbox"><label for="sample">부서정보 :</label>
            <input value="엑셀다운로드" id="sample" type="button" onclick="excel2()" class="btn small edge mako"> 
            </p>
