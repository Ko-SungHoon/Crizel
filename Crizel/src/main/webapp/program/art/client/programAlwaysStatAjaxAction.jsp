...
String al_deep  =   parseNull(request.getParameter("al_deep"), "alway");
...
try {
    ...
    if (Integer.parseInt(pro_cat) < 0) {
        ...
        sql_str +=  " WHERE CODE_TBL = 'ART_PRO_"+ al_deep.toUpperCase() +"' AND CODE_COL = 'PRO_CAT_NM' ";
        ...
        sql_str +=  " FROM ART_PRO_"+ al_deep.toUpperCase() +" A JOIN ART_PRO_CODE B ";
