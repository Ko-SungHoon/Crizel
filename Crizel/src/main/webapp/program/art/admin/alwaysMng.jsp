...
sql.append("		WHERE DEL_FLAG = 'N' AND PRO_TYPE = 'NEW'	");
if(!"".equals(year)){
...
sql.append("		FROM ART_PRO_ALWAY		 							");
sql.append("		WHERE DEL_FLAG != 'Y' AND PRO_TYPE = 'NEW'			");
if(!"".equals(year)){
sql.append("		AND PRO_YEAR = ?					");
paging.setParams("year", year);
}
...
<div id="right_view">
		<div class="top_view">
				<p class="location"><strong>프로그램 운영 > 프로그램 관리(상시)</strong></p>
				<p class="loc_admin">
...
<!-- S : #content -->
	<div id="content">
		<div class="btn_area">
			...
			<button type="button" class="btn medium mako" onclick="location.href='/program/art/admin/alwaysMng.jsp'">프로그램 관리 - 상시</button>
			<%} %>
		...
		<div class="f_r">
			...
			<button type="button" class="btn small edge green" onclick="getPopup('insert');">상시추가</button>
		</div>
		<p class="f_l magT10">
