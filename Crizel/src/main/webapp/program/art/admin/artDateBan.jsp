...
public List<BanVO> getVO(String year){
	...
	try {
		Document document = Jsoup.connect("https://apis.sktelecom.com/v1/eventday/days?month=&year="+year+"&type=h&day=")
				...
				.header("TDCProjectKey", "b88306d3-cd97-4f13-9350-ee8f3a95d1fd")
				.header("referer", "https://developers.sktelecom.com/projects/project_85841741/services/EventDay/Analytics/")
...
try{
	...
	for(BanVO ob2 : list){	//	공휴일을 DB에 저장
	    ...
	    pstmt.addBatch();
	    out.println(ob2.year + "-" + ob2.month + "-" + ob2.day + "<br>");
	    out.println(banno++ + "<br>");
	    out.println(ob2.year + "<br>");
	    out.println(ob2.name + "<br>");
	    out.println(ob2.year + "-" + ob2.month + "-" + ob2.day + "<br><br>");
	}
