...
function approvalSubmit(req_no){
	var addr = "/program/art/client/programDeepReqAction.jsp?dataType=app&req_no="+req_no;
	location.href=addr;
    return;
}

function cancelSubmit(req_no){
	var addr = "/program/art/client/programDeepReqAction.jsp?dataType=can&canAdmin=A&req_no="+req_no;
	location.href=addr;
    return;
}
