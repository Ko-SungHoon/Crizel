    ...
    if (dataType.equals("ins")) {
        ...
        try {
            ...
            if(result > 0){
                ...
                out.println("location.href='/index.gne?menuCd=DOM_000000126002003006';");
                out.println("</script>");
            } else {
                out.println("<script>");
...
/** 신청 update & insert **/
        ...
        try {
            ...
            if(result > 0){
                out.println("<script>");
                out.println("alert('정상적으로 처리되었습니다.');");
                out.println("location.href='/index.gne?menuCd=DOM_000000126002003008&req_no="+ req_no +"&req_date="+ req_date +"';");
                out.println("</script>");
            } else {
                out.println("<script>");
                out.println("alert('저장되지 않았습니다. 관리자에게 문의하세요.');");
...
/** 승인 approval **/
        ...
        try {
            ...
            if (result > 0) {
                out.println("<script>");
                out.println("alert('정상적으로 처리되었습니다.');");
                out.println("location.href='/index.gne?menuCd=DOM_000000126006001001';");
                out.println("</script>");
            } else {
                out.println("<script>");
...
/** 취소 신청 cancel (사용자 & 관리자) **/
        ...
        try {
            ...
            if (result > 0) {
                out.println("<script>");
                out.println("alert('정상적으로 처리되었습니다.');");
                if (canAdmin.equals("A")) out.println("location.href='/index.gne?menuCd=DOM_000000126006001001';");
                else out.println("location.href='/index.gne?menuCd=DOM_000000126002003006';");
                out.println("</script>");
            } else {
                out.println("<script>");
                out.println("alert('처리되지 않았습니다. 관리자에게 문의하세요.');");
