                ...
                <input type="hidden" id="aft_flag" name="aft_flag" value="A">
					...
					<table class="bbs_list2">
						...
						<tr>
							...
							<td>
								<input type="text" id="pro_name" name="pro_name" value="<%=parseNull(vo.pro_name)%>" required>
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr>
							...
							<td>
								<input type="text" id="max_per" name="max_per" value="<%=vo.max_per%>" required>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<input type="radio" id="show_flag" name="show_flag" value="Y" <%if("Y".equals(vo.show_flag)){%> checked="checked" <%}%> required>Y
								<input type="radio" id="show_flag" name="show_flag" value="N" <%if("N".equals(vo.show_flag)){%> checked="checked" <%}%> required>N
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								<textarea rows="20" cols="100" id="pro_memo" name="pro_memo" required><%=parseNull(vo.pro_memo)%></textarea>
							</td>
						</tr>
						</tbody>
					</table>
