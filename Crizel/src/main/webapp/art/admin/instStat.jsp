...
else {end_date    =   Integer.toString(cal.get(Calendar.YEAR)) + "-" + addZero(cal.get(Calendar.MONTH)+1) + "-" + addZero(cal.get(Calendar.DAY_OF_MONTH));}
	...
	<div id="content">
		<div class="btn_area">
			<p class="boxin">
				...
				<button type="button" class="btn medium mako" onclick="location.href='/program/art/admin/instStat.jsp'">통계관리</button>
			</p>
		</div>
