...
<form id="postForm">
	type : <input type="text" id="type" name="type" value="<%=type%>"> <br>
	tname : <input type="text" id="tname" name="tname" value="<%=tname%>"> <br>
	search1 : <input type="text" id="search1" name="search1" value="<%=search1%>"> <br>
	search2 : <textarea rows="10" cols="50" id="search2" name="search2"><%=search2%></textarea>
	<button type="button" onclick="formSubmit()">검색</button><br>
