...
String returnCtnSid = "http://www.gne.go.kr/phoneTest/gpinAction.jsp";
String returnUrl = URLEncoder.encode("http://www.gne.go.kr/phoneTest/index.jsp", "UTF-8");
...
dupInfo : <%=dupInfo %> <br>
phoneDi : <%=phoneDi %> <br>
<a href="http://www.gne.go.kr/G-PIN3/Sample-AuthRequest.jsp?returnCtnSid=<%=returnCtnSid%>&amp;returnUrl=<%=returnUrl%>" onclick="window.open(this.href, 'gpinWindow', 'width=500,height=500,scrollbars=yes'); return false;" title="새창으로 열립니다." target="_blank" class="button bblue">공공아이핀 인증하기</a> <br>
...
<a href="http://www.gne.go.kr/index.gne?menuCd=DOM_000000164000000000&returnUrl=<%=returnUrl%>">휴대폰 인증하기</a>
