...
//String infoPage = "/index.gne?menuCd=DOM_000001201003001001";
String infoPage = "/index.gne?menuCd=DOM_000000106003001001";	// 테스트
...
<div class="faciList">
<form action="" method="post" class="board" id="postForm" onsubmit="return postFormSubmit();">
	...
	<table class="board_read02">
		...
		<tbody>
			<tr class="topline">
				...
				<td colspan="2"><label for="reserve_date" class="dis_mo">희망대여일</label><input type="text" name="reserve_date" id="reserve_date" value="<%=reserve_date%>" class="wps_100"></td>
			...
			<tr>
				...
				<td class="reserveType">
					<label class="dis_mo">시설명</label>
          			<span><input type="checkbox" name="reserve_typeAll" id="reserve_typeAll" value="" 
					<%if(!reserve_type_check_1 && !reserve_type_check_2 && !reserve_type_check_3 && !reserve_type_check_4) {%>
						checked="checked"
					<%} %>><label for="reserve_typeAll">전체</label></span>
				</td>
				<td class="reserveType">
				...
				<th scope="row">학교명</th>
				<td><label for="school_name" class="dis_mo">학교명</label><input type="text" name="school_name" id="school_name" class="wps_100" value="<%=school_name%>"></td>
			</tr>
		</tbody>
	</table>
...
%>
	<tr>
		...
		<td class="sch_name"><span class="dis_mo">학교명</span><a href="javascript:school_info('<%=school_id%>', '<%=infoPage%>');"><%=school_name%></a> </td>		<!-- 실서버 -->
