            ...
            <fieldset>
                ...
                <div class="box_area login_top">
                    <div class="input_form">
                        <p class="">아이디</p>
                        <p class="input_id"><input type="text" id="userid" name="userid" title="아이디" placeholder="아이디" style="ime-mode:disabled;" npkencrypt="key"></p>
                        <p class="mt_20">비밀번호</p>
                        <p class="input_pw"><input type="password" id="passwd" name="passwd" title="비밀번호" placeholder="비밀번호" style="ime-mode:disabled;" npkencrypt="key"></p>
