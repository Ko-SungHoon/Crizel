...
<div class="btn_area c">
	<!-- <button type="button" onclick="location.href='/index.gne?menuCd=DOM_000001201007002000'" class="btn medium edge mako">목록보기</button> -->
	<button type="button" onclick="location.href='/index.gne?menuCd=DOM_000000106007002000'" class="btn medium edge mako">목록보기</button>		<!-- 테스트서버 -->
</div>
</form>
