var apiURL = 'http://lib.gyeongnam.go.kr/kdotapi/ksearchapi/nonbooksearch?manage_code=MA'
...
var bookSearch = new Vue({
  ...
  methods: {
    fetchData: function() {
      ...
      var searchText = '&' + self.searchSelect +'='+self.searchText + '&search_type=detail' + '&search_shelf=012'
