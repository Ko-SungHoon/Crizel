    ...
    '<table class="table_c">',
      ...
      '<tbody>',
        '<tr>',
          ...
          '<td v-if="record.LOAN_CHECK == 0 && record.RESERVATION_CNT == 0 && record.BOOK_STATUS == 1">대출가능</td>',
          '<td v-else-if="record.LOAN_CHECK == 0 && (record.RESERVATION_CNT == 1 || record.RESERVATION_CNT == 2)">예약대출대기중</td>',
