...
<body>
    <ul>
    	<li><a href="registerAgree.jsp">회원가입</a></li>
    	<li><a href="idSearch.jsp">아이디 찾기</a></li>
    	<li><a href="pwConfirm.jsp">비밀번호 재설정</a></li>
    	<li><a href="userInfoModify.jsp">정보수정</a></li>
    	<li><a href="userDrop.jsp">회원탈퇴</a></li>
