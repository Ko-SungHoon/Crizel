            ...
            <fieldset>
                ...
                <div class="join1">
                    <div class="box_area">
                        ...
                        <div class="certify">
                            <!-- <div class="member1">
                                <button class="btn general">일반회원<br>(14세이상 내국인)</button>
                                <button class="btn child">어린이회원<br>(14세미만 내국인)</button>
                            </div>
                            <div class="box_mini txt_small">
                                어린이회원(14세 미만)은 보호자의 동의 절차가 필요합니다.<br>
                                어린이회원의 본인 인증 방법을 선택해 주세요.
                            </div> -->
                            <div class="certify1">
                                ...
                                <p class="btn_medium">
                                    <a href="register.jsp" onclick="">휴대폰 인증받기</a>
                                </p>
