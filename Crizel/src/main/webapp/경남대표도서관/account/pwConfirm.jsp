...
<head>
    ...
    function pwReset(){
    	...
    	$("#login_form").submit();
    	//location.href="pwReset.jsp?id="+id+"&ipin_hash="+ipin_hash;
    }
    </script>
</head>
<body>
    ...
    <div class="login_area">
        <form id="login_form" name="login_form" action="pwReset.jsp" method="post">
            <fieldset>
                ...
                <div class="box_area">
                    ...
                    <div class="box_mini">
                        <p class="txt_small">본인 확인을 위해 아이디 입력 후 휴대전화 인증 또는 아이핀인증을 실행해주세요.</p>
                    </div>
                    ...
                    <div class="find_id">
                        ...
                        <div class="member_info">
                            <div class="input_name">
                                <p class="txt_small">아이디입력 <span class="c_red">(필수)</span></p>
                                <input type="text" name="id" title="아이디입력" id="id" placeholder="아이디입력" value="">
                            </div>
                        </div>
                        <!-- //아이디입렵 -->
                        <!-- 회원가입 인증 -->
                        <div class="certify">
                            <div class="certify1">
                                ...
                                <p class="btn_medium">
                                    <a href="#" onclick="pwReset();">휴대폰 인증받기</a>
                                </p>
