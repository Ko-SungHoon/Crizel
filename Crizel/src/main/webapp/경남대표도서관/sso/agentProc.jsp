...
<form id="sendForm" name="sendForm" action="<%=request.getContextPath()%>/index.lib?contentsSid=176" method="post">
   	 	<input type="hidden" name="return">
		<input type="hidden" name="hash">
    	<input type="hidden" id="userid" name="userid" value="<%=session.getAttribute("ID")%>">
    	<input type="hidden" id="passwd" name="passwd" value="<%=session.getAttribute("PWD")%>">    
    </form>
