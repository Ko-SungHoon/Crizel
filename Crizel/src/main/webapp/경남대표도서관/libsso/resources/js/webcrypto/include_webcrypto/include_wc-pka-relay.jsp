...
%>
    <link rel="stylesheet" type="text/css" href="<%=baseURL%>/ui_template_relay/css/certificate_ui.css?v=<%=version%>">
...
<%  } %>
    <script type="text/javascript" src="<%=baseURL%>/ui_template_relay/ui_template.js?v=<%=version%>" charset="UTF-8"></script>
