...
if(viewYN == 1){
	...
	try{
		...
		//조사팀장
			...
			//반려
				...
				if(!"".equals(dataVO.item_comp_no) && !"".equals(dataVO.item_comp_val)){
					...
					resultCnt	=	jdbcTemplate.update(sql.toString(), new Object[]{
							foodVO.t_rj_reason, foodVO.rsch_val_no, foodVO.rsch_val_no, foodVO.rsch_no
							});
		...
		if(actType == 0)		obj.put("resultMsg", "0" + e.toString());
		else if(actType	== 1)	obj.put("resultMsg", "1" + e.toString());
		else if(actType == 2)	obj.put("resultMsg", "2" + e.toString());
		else if(actType == 3)	obj.put("resultMsg", "3" + e.toString());
